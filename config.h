...
#define ADC_X4_MIN_VALUE 43
#define ADC_X4_MAX_VALUE 182
#define LEVEL_1 50
#define LEVEL_2 62
#define LEVEL_3 74
#define LEVEL_4 87
...
#define EEPROM_INIT_MAGIC_BYTE 194 // makes sure (chance of fail 1/255) eeprom is invalidated after flashing new config
